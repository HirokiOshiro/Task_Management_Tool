    ...
    sections: {
      ...
      task: {
        ...
        items: [
          ...
          'Use the notes section at the bottom of the detail panel to write free-form notes',
        ],
      },
      views: {
        title: '4 Views',
        switchTabs: 'Switch views using the tabs in the header.',
        table: { name: 'Table', desc: 'List tasks like a spreadsheet. Click cells to edit directly, and adjust column widths.' },
        kanban: { name: 'Kanban', desc: 'Display cards by status. Drag & drop to change status.' },
        gantt: { name: 'Gantt Chart', desc: 'Display task start dates to due dates as bars. Drag bars to move schedules, or drag bar edges to adjust duration.' },
      ...
      sidebarHelp: {
        ...
        viewManagementDesc: 'Add, rename, and delete views',
