  ...
  help: {
    ...
    sections: {
      ...
      dataSection: {
        ...
        openFileDesc: 'Select and load a JSON or Excel (.xlsx) file. Security validation runs during import, and data with invalid structure or unsupported keys may be skipped.',
        ...
        saveJsonNote: '. All information including field configurations and notes is saved, making it the best backup format for restore.',
        saveExcelTitle: 'Save as Excel',
        saveExcelDesc: 'Download task data as an Excel file (.xlsx). Convenient for viewing and sharing in Excel or Google Sheets. For safety, text that starts with = / + / - / @ is exported as plain text.',
      ...
      caution: {
        ...
        items: [
          ...
          { title: 'File Backup Recommended', desc: 'Auto-save is browser-only. In addition to browser data/cache clearing, restore can be blocked for safety if stored data is detected as corrupted or invalid. Please back up important data regularly with "Save as JSON".' },
          ...
          { title: 'Shared Devices', desc: 'On shared PCs, data remains in browser local storage. Save as JSON after use, clear browser data when needed, and avoid storing sensitive information long-term.' },
